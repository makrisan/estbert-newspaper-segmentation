...
One can reference Figures (see Figure \ref{fig:taltech} for example) as well as cite references which are defined in the \textit{references.bib} file \cite{spectre}, \cite{example-reference}, \cite{pretrained-language-specific-BERT}, \cite{digar}, \cite{oberbichler2025llmnewspapers}, \cite{kudo2018sentencepiece}, \cite{niitmudelikohandamine}, \cite{mauermann2025llmbias}, \cite{lehtmets2024ocr}.
