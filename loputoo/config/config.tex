...
\newcommand{\thesisTitleEng}{Language model-based newspaper article extraction and thematic analysis} % variable with thesis title
\newcommand{\thesisTitleEst}{Keelemudelipõhine ajaleheartiklite eraldamine ja temaatiline analüüs} % Title in Estonian

% Choose your thesis
\newcommand{\thesisType}{Bachelor's Thesis}

% Thesis author
\newcommand{\authorName}{Greteli Mittal}
\newcommand{\studentcode}{IAIB233041}

% Second author. If you are the sole author, leave it as it is
\newcommand{\authorNameTwo}{Maria Kristina Andranikyan}
\newcommand{\studentcodeTwo}{IAIB2}
...
% Main supervisor
\newcommand{\supervisorName}{Innar Liiv}
